          ...
          return {
            ...
            gravity: function () {
              switch (gravity) {
                ...
                default:
                  console.log("invalid object gravity value, fallback to normal");
                  return GRAV_NORMAL;
              }
            }()
          };
...
var levToSvg = function levToSvg(data) {
  ...
  var svg = "<svg xmlns=\"http://www.w3.org/2000/svg\" xmlns:svg=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" viewBox=\"".concat(minx, " ").concat(miny, " ").concat(maxx - minx, " ").concat(maxy - miny, "\">\n          <g><path d=\"").concat(paths.join(" "), "\" class=\"sky\" style=\"fill: #f1f1f1; fill-rule: evenodd\"/></g>").concat(level.objects.map(function (o) {
    return "<circle class=\"".concat(o.type, " ").concat(o.gravity, "\" cx=\"").concat(o.x, "\" cy=\"").concat(o.y, "\" r=\"0.4\" fill=\"").concat(function () {
      switch (o.type) {
        case APPLE:
          return "#af3030";
